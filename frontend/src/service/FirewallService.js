...
const FirewallService = ({ children }) => {
   ...
   const firewallService = {
     ...
     // post syn-recv-update /api/firewall/syn-recv/update
     async syn_recv_update(content) {
         const response = await fetch(
     ...
     // delete syn-recv/delete /api/firewall/syn-recv/delete
     async syn_recv_delete(content) {
         const response = await fetch(
